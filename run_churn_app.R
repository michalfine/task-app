# Standalone Churn Prediction App Launcher
# This script runs only the Shiny app (assumes model is already trained)
...
if(!file.exists("final_churn_model.rds")) {
  stop("ERROR: final_churn_model.rds not found!\n",
       "Please run the training section of churn_app_fixed.R first to create the model.")
}
